...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es3a/](https://arquisoft.github.io/lomap_es3a/) necesitamos ejecutar `npm run deploy`.
