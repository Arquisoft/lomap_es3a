...
| _Users>_ | Anyone who uses the app 
...
| _<They will supervise the students making sure they are taking the right path and helping if necessary. 

| _Empathy_ | Empathy, tech company 
| _<They are interested in the project, especially in how the team uses SOLID technology, since this is essential in their work area. 
|=== 
