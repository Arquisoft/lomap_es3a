...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es3a/](https://arquisoft.github.io/lomap_es3a/) we need to execute `npm run deploy`.
